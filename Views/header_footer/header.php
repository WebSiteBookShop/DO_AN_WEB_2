<header style="box-shadow: 5px 3px 10px #000;background:#F6F283" class="header-one header-two">
                                        ...
                                        <?php $i = 1; foreach ($data_chitietDM as $row) { ?>
                                            <li >
                                                ...
                                                <ul >
                                                    ...
                                                    <li style="text-align: center;"><a href="?act=shop&sp=<?=$value['MaDM']?>&loai=<?=$value['TenLSP']?>"><?=$value['TenLSP']?></a></li>
                                                    <?php }?>
                                                </ul>
                                            </li>
                                        <?php $i++; } ?>

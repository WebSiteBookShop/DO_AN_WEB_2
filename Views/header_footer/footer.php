                            ...
                            <div class="footer-text">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <p>chihieu@gmail.com</p>
                                        <p>thanhnhan@hotmail.vn</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="single-text">
                            ...
                            <div class="clearfix instagram">
                                <ul>
                                    ...
                                    <li><a href="#" style="width:65px; height:65px"><img src="public/img/footer/in5.png" alt="Instagram" /></a></li>
                                    <li><a href="#" style="width:65px; height:65px"><img src="public/img/footer/in2.png" alt="Instagram" /></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>

 <!-- Sidebar -->
 <ul style="  background: linear-gradient(#5fc9b5 , #31334e);" class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar">
...
<li class="nav-item">
  <a class="nav-link" href="?mod=nguoidung">
    ...
    <span>Danh Mục Tài khoản</span></a>
</li>
<?php } ?>
<!-- Nav Item - Tables -->
<li class="nav-item">
...
<li class="nav-item">
  <a class="nav-link" href="?mod=khuyenmai">
    <i class="fas fa-fw fa-table"></i>
    <span>Danh Mục khuyến mãi</span></a>
</li>
